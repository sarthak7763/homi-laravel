...
<head>
  ...
  <title>Huboffercity-Reset Password</title>
</head>
        ...
        <table style="width: 100%; background-color:#B6D8FA; padding: 15px;">
          <tr>
            <td style=" background-color: #B6D8FA; padding: 10px;">
                      <p style="margin: 0; padding: 0 0 10px; font-size: 14px; color: #000; font-weight: 500;">Hello {{ $messageBody ? $messageBody['name'] : '' }}</p>
                      <p style="margin: 0; padding: 0 0 20px; font-size: 14px; color: #000; font-weight: 500;">   We've received a request to reset the password. You can reset your password by clicking the button below:</p>
                      <p style="margin: 0; padding: 0 0 20px; font-size: 18px; color: #000; font-weight: 500;"> <a href="{{route('buyer-reset-password-link',$messageBody['token'])}}" style="color: #fff;background-color: #004E64;border-color: #004E64;font-weight: bold;letter-spacing: 0.05em;padding: 5px 10px 5px 10px;border: 1px solid black;text-decoration: none;">Reset your password</a></p>
                      <p style="margin: 0; padding: 0 0 5px; font-size: 18px; color: #000; font-weight: 500;">Thank You</p>
                      <p style="margin: 0; padding: 0 0 15px; font-size: 18px; color: #000; font-weight: 500;">Huboffercity</p>
                      <div style="margin: 0; padding: 0 0 15px; font-size: 18px; color: #000; font-weight: 500;">
