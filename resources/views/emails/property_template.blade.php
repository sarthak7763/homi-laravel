        ...
        <table style="width: 100%; background-color: #fff; padding: 15px 15px;">
          <tr>
            <td style="text-align: center;">
              <img src="{{asset('assets_front/images/brand-logo/logo.png')}}" alt="Offercity" alt="logo" style="width: 140px;">
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td>
        <table style="width: 100%; background-color:#B6D8FA; padding: 15px;">
         {{--@if(@$message_top != "" || $message_top_heading != "")
          <tr>
            <td>
             @if(@$message_top!="")
               <h2 style="display: block; text-align: center; padding: 10px 0 0; margin: 0; font-size: 42px; color: #000; font-family: 'Prompt-Bold';">{{@$message_top}}</h2>
              @endif
              @if($message_top_heading!= "")
               <p style="margin: 0; padding: 5px 0 30px; color: #000; font-weight: 400; text-align: center; ">{{@$message_top_heading}}</p>
              @endif
            </td>
          </tr>
          @endif --}} 
         ...
         <td style=" background-color: #B6D8FA; padding: 10px;">
              <img src="{{@$property_image}}" alt="home" style="width: 600px;">
            <div style="text-align: left; padding-top: 5px;">
                <a style="text-align: left; background-color: #fff; padding: 10px 15px; color: #000; display: inline-block; margin: 0 auto; text-decoration: none; font-size: 14px;" href="#">STATUS : {{@$escrow_status}}</a>
                <h3 style="font-size: 24px; color: #000; font-family:'Prompt-Semibold'; margin: 0; padding: 15px 0 0;">{{@$property_name}}</h3>
             
                <div style="font-size: 14px; color: #000; line-height: 20px; font-family: 'Prompt-Regular';">   {!!$messageBody!!}
