...
class SendAddBidMailToBidders implements ShouldQueue
{
    ...
    {
      $username="";
      $mail_action_name=$this->details[0];
      $mail_params=$this->details[1];
      $send_email=$this->details[2];
      $username=@$this->details[3];
      $response=0;
      ...
      if($emailTemplates[0]['status']==1){
        ...
        Mail::send('emails.buyer_template', array('messageBody'=> $messageBody,'username'=>@$username), function ($message) use ($messageBody,$email,$email_subject) {
