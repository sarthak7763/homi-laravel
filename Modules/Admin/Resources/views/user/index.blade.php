        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="page-header my-2">
                    ...
                    <a class="btn btn-primary btn-round" href="{{route('admin-user-add')}}">Add User</a>
...
$('.datepicker').datepicker({
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if(data.success==1){
                            ...
                            if(status=="Active"){
                             toastr.success("User status active successfully");
                            }else{
                                  toastr.error("User status inactive successfully");
                            }
    ...
    { 
            ...
            var id = $(this).attr('id');
            var change_btn = $(this);
            var url = "{{ route('admin-user-email-status-update') }}";
                        ...
                        if(data.success==1){
                            ...
                            if(status=="Active"){
                             toastr.success("User verified successfully");
                                  ...
                                  toastr.error("User not verified successfully");
                            }
