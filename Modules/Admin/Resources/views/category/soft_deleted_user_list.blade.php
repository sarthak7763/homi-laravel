...
@section('title', 'Soft Deleted Buyers List')
@section('content')
...
<div class="pcoded-content">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Soft Deleted Buyers List</h4>
                                    <span></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin-user-list')}}">Soft Deleted Buyers List</a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function table_ajax(){
           ...
           // render: true,
           ajax: {
            url: "{{ route('admin-soft-deleted-user-list') }}",
            type: 'GET',
            data: function (d) {
                d.status = $('#status').val(),
        ...
        { 
            ...
            var id = $(this).attr('id');
            var change_btn = $(this);
            var url = "{{ route('admin-destroy-user') }}";
            ...
            var title ='Are you sure to delete this user premanently ?';

            var subtitle=" All data of this user deleted and never recovered again.";
            e.preventDefault();      
            swal({
              title: title,
              text:subtitle,
              ...
              if(isConfirm){
                $.ajax({
                    ...
                    success: function (data){
                     table_ajax();
                     toastr.success("Buyer Deleted Completely.");
                       // change_btn.html(status);
                        //change_btn.removeClass(status_class).addClass(newClass);
                    }         
                })
        ...
        $(document).on('click', '.badge_restore', function(e)
        { 
            var status_class = $(this).attr('class');
            ...
            if(status_class == "badge badge-danger")
            {
                var newClass = "badge badge-success badge_restore";
                var status = 'Not Deleted';
            }else
            {
                var newClass = "badge badge-danger";
            ...
            var title ='Are you sure to restore this user ?';
          ...
          if(isConfirm){
            $.ajax({
                ...
                success: function (data){
                 table_ajax();
                 toastr.success("Buyer restored successfully");
                       // change_btn.html(status);
                        //change_btn.removeClass(status_class).addClass(newClass);
                    }         
                })
