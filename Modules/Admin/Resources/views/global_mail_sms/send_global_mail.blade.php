                            ...
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    <li class="breadcrumb-item">
                                     ...
                                     <li class="breadcrumb-item"><a href="{{route('admin-global-mail-send')}}">Send Mail</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
               ...
               @if ($message = Session::get('success'))
                ...
                @endif
                                <div class="card-block">
                                       <form method="POST" action="{{route('admin-global-mail-send-post')}}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                         <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="e1" class="form-control js-example-placeholder-multiple @error('user_id') is-invalid @enderror" name="user_id[]" multiple="multiple">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold">Mail Subject</label>
                                                    <input type="text" class="form-control @error('subject') is-invalid @enderror" name="subject" id="subject" required="required">
                                                    @error('subject')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold">Mail Body</label>
                                                    <textarea  rows="10" cols="5" class="form-control @error('message') is-invalid @enderror" name="message" id="message" required="required"></textarea>  
                                                    @error('message')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
      ...
      $.ajax({
        ...
        success:function(response){
            if(response.status=="success") {
                  CKEDITOR.instances['message'].setData(response.result.body);
