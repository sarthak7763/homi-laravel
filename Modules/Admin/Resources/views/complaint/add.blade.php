                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{route('admin-user-complaint-save')}}"  enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label font-weight-bold">Complaint Attachments</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                            <textarea rows="5" cols="3" id="content" name="description" class="form-control @error('description') is-invalid @enderror"></textarea>
                                            @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                @elseif(Auth::user()->hasRole('sub-admin'))
                                                    ...
                                                    @if(auth()->user()->can('admin-user-complaint-save'))
