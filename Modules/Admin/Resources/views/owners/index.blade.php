                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin-owners-list')}}">Owners List</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <a class="btn btn-primary btn-round" href="{{route('admin-owners-add')}}">Add Owner</a>
...
$('.datepicker').datepicker({
  dateFormat: 'yy-mm-dd'
    ...
    { 
            ...
            var id = $(this).attr('id');
            var change_btn = $(this);
            var url = "{{ route('admin-owners-status-update') }}";
           ...
           var title ='Are you sure to '+status+' this Owners ?';
            e.preventDefault();      
            swal({
              title: title,
              icon: "warning",
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if(data.success==1){
                            ...
                            if(status=="Active"){
                             toastr.success("Owners status active successfully");
                            }else{
                                  toastr.error("Owners status inactive successfully");
                            }
            ...
            // else {
            //     swal("Cancelled", "Owners status not change", "error");
            // }
            });         
    }); 
    ...
    { 
            ...
            var id = $(this).attr('id');
            var change_btn = $(this);
            var url = "{{ route('admin-owners-delete') }}";
           ...
           var title ='Are you sure to delete this Owners ?';
            e.preventDefault();      
            swal({
              title: title,
              icon: "warning",
              ...
              if(isConfirm){
                $.ajax({
                    ...
                    success: function (data){
                       table_ajax();
                        toastr.error('Owners deleted successfully!');
                       // change_btn.html(status);
                        //change_btn.removeClass(status_class).addClass(newClass);
                    }         
                })
            ...
            // else {
            //     swal("Cancelled", "Owners not deleted", "error");
            // }
            });         
    });   
