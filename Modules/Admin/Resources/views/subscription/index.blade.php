        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="page-header my-2">
                    ...
                    <a class="btn btn-primary btn-round" href="{{route('admin-subscription-add')}}">Add Subscription</a>
...
$('.datepicker').datepicker({
  dateFormat: 'yy-mm-dd'
    ...
    { 
           ...
           var title ='Are you sure to '+status+' this Buyer ?';
            e.preventDefault();      
            swal({
              title: title,
              icon: "warning",
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if(data.success==1){
                            ...
                            if(status=="Active"){
                             toastr.success("Buyer status active successfully");
                            }else{
                                  toastr.error("Buyer status inactive successfully");
                            }
            ...
            // else {
            //     swal("Cancelled", "Buyer status not change", "error");
            // }
            });         
    }); 
    ...
    { 
           ...
           var title ='Are you sure to delete this Subscription ?';
            e.preventDefault();      
            swal({
              title: title,
              icon: "warning",
              ...
              if(isConfirm){
                $.ajax({
                    ...
                    success: function (data){
                       table_ajax();
                        toastr.error('Subscription deleted successfully!');
                    }         
                })
            } 
            });         
