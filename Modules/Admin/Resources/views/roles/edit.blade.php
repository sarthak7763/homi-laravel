                            ...
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin-role-list')}}">Role List</a> </li>
                                     <li class="breadcrumb-item"><a href="{{route('admin-edit-role',$role->id)}}">Edit Role</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                @endif
                               <!--  <div class="card-header">
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{route('admin-update-role',$role->id)}}"  enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$role->name}}" class="form-control @error('name') is-invalid @enderror" name="name" id="name" required="required">
                                                    @error('name')
