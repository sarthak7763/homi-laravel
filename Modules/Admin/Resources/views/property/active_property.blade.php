...
@section('title', 'Active Property List')
@section('content')
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin-active-property-list')}}">Active Property List</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
      ...
      var table = $('#propertytable').DataTable({
        processing: true,
           serverSide: false,
            "bDestroy": true,
        ajax: {
            url: "{{ route('admin-active-property-list') }}",
            type: 'GET',
             data: function (d) {
                d.status = $('#status').val(),
