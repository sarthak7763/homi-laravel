...
@section('title', 'Soft Deleted Property List')
@section('content')
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Soft Deleted Property List</h4>
                                    <span></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin-property-list')}}">Soft Deleted Property List</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
function table_ajax(){
  ...
  var table = $('#propertytable').DataTable({
    ...
    "bDestroy": true,
    ajax: {
        url: "{{ route('admin-soft-deleted-property-list') }}",
        type: 'GET',
        data: function (d) {
            d.status = $('#status').val(),
...
$(document).ready(function() {
    ...
    { 
        ...
        var id = $(this).attr('id');
        var change_btn = $(this);
        var url = "{{ route('admin-destroy-property') }}";
        ...
        var title ='Are you sure to delete this property permanently?';
        e.preventDefault();      
        swal({
          title: title,
          icon: "warning",
...
{ 
    ...
    var change_btn = $(this);
    var url = "{{ route('admin-property-restore') }}";
    ...
    var title ='Are you sure to restore this property ?';
