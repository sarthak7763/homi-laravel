                          ...
                          <div class="form-group">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input style="padding: 8px 10px;" type="text" name="built_in_year" class="form-control datepicker" value="{{$propertyInfo->built_in_year}}" placeholder="Enter Built In Year"  id="built_in_year" >
                            ...
                            <div class="form-group country-select">
                                ...
                                <select id="country_code" name="country_code" class=" form-control">
                                  @foreach($country_list as $list)
                                    <option {{$propertyInfo->country_code ==$list ? "selected" : "" }} value="{{$list}}">
                                      {{$list}}</option>
                                  @endforeach
                                </select>
