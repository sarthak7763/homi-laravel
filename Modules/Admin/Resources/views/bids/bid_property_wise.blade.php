                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{route('admin-bid-list')}}">{{@$heading}}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
function table_ajax(){
    ...
    "bDestroy": true,
    ajax: {
        url: "{{ route('admin-bid-property-wise-post',[$property_id,$status]) }}",
        type: 'GET',
        data: function (d) {
            d.status = $('#status').val(),
              ...
              if(isConfirm){
                $.ajax({
                    ...
                    success: function (data){
                        ...
                        toastr.success("Bid status updated successfully");
                    }         
                })
            } else {
            ...
            $.ajax({
                ...
                success: function (response){
                    if (response.status == "200") {
                       ...
                       toastr.success("Bid deleted successfully");
                    } else {
