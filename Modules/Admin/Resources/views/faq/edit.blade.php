                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('question') is-invalid @enderror" name="question" id="question" required="required" value="{{@$faqInfo->question}}">
                                                    @error('question')
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" rows="10" cols="10" class="form-control @error('answer') is-invalid @enderror" name="answer" id="answer" required="required">{{$faqInfo->answer}}</textarea>
                                                    @error('answer')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status">
                                                        <option value="1" {{ $faqInfo->status == "1" ? 'selected' : '' }}>Enable</option>
                                                        <option value="0" {{ $faqInfo->status == "0" ? 'selected' : '' }}>Disable</option>
                                                    </select>
                                                    @error('status')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
