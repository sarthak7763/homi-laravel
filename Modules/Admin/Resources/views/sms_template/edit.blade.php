                            ...
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin-sms-template-list')}}">Sms Template List</a> </li>
                                     <li class="breadcrumb-item"><a href="{{route('admin-sms-template-edit',$smsTemplate->id)}}">Add Sms Template</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                               <!--  <div class="card-header">
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{route('admin-sms-template-update')}}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                 <input type="hidden"  name="id" value="{{$smsTemplate->id}}">
                                                    ...
                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{$smsTemplate->name}}" placeholder="Enter Sms Name">
                                                    @error('name')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('action') is-invalid @enderror" name="action" onchange="getParameters()" id="action" required>
                                                        ...
                                                        <option value="{{$li->action}}" @if($li->action == $smsTemplate->action) selected @endif>{{$li->action}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="font-weight-bold">Sms Template Body<span style="color:red;">*</span></label>
                                                    <small class="text-danger">Please do not change short codes.</small>
                                                    <textarea  class="form-control @error('body') is-invalid @enderror" name="body" id="body" rows="10" cols="10">{{$smsTemplate->body}}</textarea>
                                                    @error('body')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                @elseif(Auth::user()->hasRole('sub-admin'))
                                                    ...
                                                    @if(auth()->user()->can('admin-sms-template-update'))
                                                       <button type="submit"  class="btn btn-primary m-b-0">Update</button>
