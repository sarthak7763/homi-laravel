                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin-notification-list')}}">Email Templates List</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <a class="btn btn-primary btn-round" href="{{route('admin-notification-add')}}">Add Notifications</a>
...
<script type="text/javascript">
  $(function () {
        var table = $('#datatable').DataTable({
            ...
            {data: 'notification image', name: 'notification image'},
