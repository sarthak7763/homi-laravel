   ...
   public function rules()
    {
        return [
           ...
           // 'address' => 'required',
            ...
            'state' => 'required',
            'city' => 'required',
            'image'        =>  'image|mimes:jpg,png,jpeg,gif,svg|max:9048|dimensions:min_width=100,min_height=100,max_width=8000,max_height=8000',
            //'latitude'=>'required',
           // 'longitude'=>'required',
        ];
    }
    ...
    public function messages(){
        return [
            ...
            //'price_to.regex'=>'Max Price should be numeric.',
