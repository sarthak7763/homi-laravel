...
class PropertyController extends Controller {
    ...
    if($request->hasFile('property_image')){
        ...
        if(isset($request->features))
        {
          ...
          if($data['property_description']!="")
          {
            ...
            $property->country_code=$data['country_code'];
        ...
        if(isset($request->features))
        {
            ...
            if($propertyupdate->title==$data['title'])
            {
                if($fileNameToStore!="")
                {
                    ...
                    $propertyupdate->country_code=$data['country_code'];
    ...
    public function show($slug){
        try{
            ...
            $publish_date = date('d M, Y',strtotime($propertyInfo->publish_date)) ;
            ...
            return view('admin::property.show',compact('propertyInfo','property_gallery','publish_date'));  
        }
        catch(Exception $e){
            return redirect()->back()->with('error', 'something wrong');     
        }  
