...
Route::get('/add-notifications', 'NotificationController@add')->name('admin-notification-add');
Route::post('/save-notifications', 'NotificationController@store')->name('admin-notification-save');
Route::get('/delete-notifications', 'NotificationController@destroy')->name('admin-notification-delete');
