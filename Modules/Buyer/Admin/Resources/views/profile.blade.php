...
.update-table .profile-box img{max-width: 100%}
.card {
               ...
               @if ($message = Session::get('success'))
                ...
                <div class="page-body">
                   <div class="row justify-content-center">
                        ...
                        <div class="col-xl-10 update-table">
                             <div class="bg-white p-2">
                            <div class="d-flex">

                               
                            <div class="profile-box py-2 w-100 bg-white text-center">
                                <label class="mb-0 pr-3 w-100" id="profile_pic_label">
                                @if(Auth()->user()->profile_pic!="")
                                <img src="{{url('/')}}/images/user/{{ Auth()->user()->profile_pic}}" class="rounded w-100" alt="User">
                                @else
                                <img  class="rounded w-100 img-fluid" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png"  id="previewHolder" width="150px"/>
                                @endif
                            </label>  
                                                       
                            </div>
                                    <div class="card mb-0 h-100 py-2 px-1">
                                 ...
                                 <a href="{{route('admin-profile-edit')}}" class="edit-btn btn mt-2">Edit</a>
                                 </div>
                                 </div>
                        </div>
