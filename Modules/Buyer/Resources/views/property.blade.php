...
@endif
                     ...
                     <div class="col">
                        <div class="manage-list-text">
                           ...
                           <p>
                              ...
                              {{$property->property_address}}    | <?php if ($property->property_status == 1) echo "Active"; else echo "Pending";?> |    Listed on:  {{$property->created_at}}
                           </p>
                           <p><?php if ($property->property_type == 1) echo "Renting"; else echo "Buying";?> | {{$property->categoryname->name}}  
                           </p>
                           <div class="manage-btn-group">
                              ...
                              <button type="button" class="btn btn-info btn-lg status_change" data-toggle="modal" data-target="#myModal" data-id="{{$property->id}}" data-status="{{$property->property_status}}">Change Status</button>
                           </div>
                        </div>
                     </div>
               </li>
         ...
         <div class="modal fade" id="myModal" role="dialog">
               ...
               <h4 class="modal-title">Do You Need update status into billed ?</h4>
               ...
               <button type="submit" class="btn btn-success" id="update_data" >Yes</button>
               </div>
               </div>
               </div>
               </div>
