         ...
         @csrf        
            ...
            <div class="form-group clrFix mt-1">
                  ...
                  @enderror
                    ...
                    <div class="form-group clrFix position-relative mt-4">
                    ...
                    <span toggle="#password" class="input-group-text togglePassword top-0" id="">
                    <i class="fa fa-eye eyeopen "></i>                                                                                     
                    <i class="fa fa-eye-close eyeclose "></i>
                  ...
                  @enderror
                    ...
                    <div class="form-group clrFix mt-4 position-relative">
                    ...
                    <span toggle="#confirm_password" class="input-group-text  top-0 togglePassword2" >
                    <i class="fa fa-eye eyeopen"></i>                                                                                     
                    <i class="fa fa-eye-close  eyeclose"></i>
