...
<style>
    @media(max-width : 575px){
        .search-input-group button.btn-search.mw-none, a.btn.btn-danger.cancel_btn.mw-none {
    min-width: auto;width: 50%;
}
    }
</style>
<div class="col-md-8 col-lg-9">
    <div class="profile-box booking_page border-0">
        <div class="profile-box-form">
            ...
            @endif
            <form action="{{route('buyer.bookings')}}" method="get" autocomplete="off" class="px-0">
                <div class="search-input-group">
                    <div class="py-3 m-0   row px-3 form-outline  w-100">                    
                        ...
                        <div class="col-md-12 date-box-submit px-2  d-flex align-items-center pt-4 pb-4 justify-content-center">
                            <button type="submit" class="btn-search font-18  btn btn-primary mx-0 mt-0 mw-none">Search</button>
                            <a href="{{route('buyer.bookings')}}" button type="button" class="btn btn-danger ms-3 mw-none font-18 cancel_btn  mx-0 mt-0 px-3">Reset</a>
                        </div>                       
                    </div>
